...
class ScrolledFrame(ttk.Frame):
    ...
    def __init__(self, master, width=None, anchor=tk.N, height=None,
                 mousewheel_speed = 2,
                 scroll_horizontally=True, xscrollbar=None,
                 scroll_vertically=True, yscrollbar=None,
                 background=None, inner_frame=ttk.Frame, **kwargs):
        """
        """
